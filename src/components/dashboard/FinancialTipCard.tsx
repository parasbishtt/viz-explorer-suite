...
export const FinancialTipCard = ({ tip }: FinancialTipCardProps) => {
  ...
  return (
    <Card className="h-full hover-lift border-border/40">
      <CardContent className="p-6">
        <div className="flex items-start space-x-4">
          <div className="flex-shrink-0">
            <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center shadow-soft">
              {IconComponent && (
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-lg font-semibold text-card-foreground mb-2 tracking-tight">
              {tip.title}
            </h3>
